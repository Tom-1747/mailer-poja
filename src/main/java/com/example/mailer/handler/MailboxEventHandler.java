package com.example.mailer.handler;

import static com.example.mailer.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.example.mailer.PojaApplication;
import com.example.mailer.PojaGenerated;
import com.example.mailer.endpoint.EndpointConf;
import com.example.mailer.endpoint.event.EventConf;
import com.example.mailer.endpoint.event.consumer.EventConsumer;
import com.example.mailer.endpoint.event.consumer.model.ConsumableEvent;
import com.example.mailer.endpoint.event.consumer.model.ConsumableEventTyper;
