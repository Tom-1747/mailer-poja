package com.example.mailer.endpoint.event.consumer;

import com.example.mailer.PojaGenerated;
import com.example.mailer.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.example.mailer.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.example.mailer.service.event."
