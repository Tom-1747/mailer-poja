package com.example.mailer.endpoint.event.model;

import static com.example.mailer.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.example.mailer.PojaGenerated;
import com.example.mailer.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "com.example.mailer.event1";
  }
}
