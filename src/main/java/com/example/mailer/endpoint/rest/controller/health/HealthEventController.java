package com.example.mailer.endpoint.rest.controller.health;

import static com.example.mailer.endpoint.rest.controller.health.PingController.KO;
import static com.example.mailer.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import com.example.mailer.PojaGenerated;
import com.example.mailer.endpoint.event.EventProducer;
import com.example.mailer.endpoint.event.model.DurablyFallibleUuidCreated1;
import com.example.mailer.endpoint.event.model.UuidCreated;
import com.example.mailer.repository.DummyUuidRepository;
import com.example.mailer.repository.model.DummyUuid;
